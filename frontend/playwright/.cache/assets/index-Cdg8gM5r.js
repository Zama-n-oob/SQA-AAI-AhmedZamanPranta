const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ErrorMessage-BqdO90zK.js","assets/jsx-runtime-BiUkNPR3.js","assets/lucide-react-rz2salZ4.js","assets/LoadingIndicator-CuIxikBd.js","assets/NotFoundMessage-Cek5IJMz.js","assets/ResultSummary-Hy7NYKNx.js","assets/SearchBar-DoRYoSt8.js","assets/ShowDocumentListList-Cnz0DQn-.js","assets/HomePage-CZUddfdO.js","assets/index-CdSqQBxY.js","assets/TestProviders-j9uGNeNt.js"])))=>i.map(i=>d[i]);
...
const C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_components_common_ErrorMessage = () => __vitePreload(() => import('./ErrorMessage-BqdO90zK.js'),true              ?__vite__mapDeps([0,1,2]):void 0).then((mod) => mod.default);
const C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_components_common_LoadingIndicator = () => __vitePreload(() => import('./LoadingIndicator-CuIxikBd.js'),true              ?__vite__mapDeps([3,1,2]):void 0).then((mod) => mod.default);
const C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_components_common_NotFoundMessage = () => __vitePreload(() => import('./NotFoundMessage-Cek5IJMz.js'),true              ?__vite__mapDeps([4,1]):void 0).then((mod) => mod.default);
const C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_components_home_ResultSummary = () => __vitePreload(() => import('./ResultSummary-Hy7NYKNx.js'),true              ?__vite__mapDeps([5,1]):void 0).then((mod) => mod.default);
const C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_components_home_SearchBar = () => __vitePreload(() => import('./SearchBar-DoRYoSt8.js'),true              ?__vite__mapDeps([6,1,2]):void 0).then((mod) => mod.default);
const C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_components_home_ShowDocumentListList = () => __vitePreload(() => import('./ShowDocumentListList-Cnz0DQn-.js'),true              ?__vite__mapDeps([7,1]):void 0).then((mod) => mod.default);
const C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_page_HomePage = () => __vitePreload(() => import('./HomePage-CZUddfdO.js'),true              ?__vite__mapDeps([8,1,0,2,3,4,5,6,7,9]):void 0).then((mod) => mod.default);
const C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_page___test_TestProviders = () => __vitePreload(() => import('./TestProviders-j9uGNeNt.js'),true              ?__vite__mapDeps([10,1,9]):void 0).then((mod) => mod.default);
__pwRegistry.initialize({ C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_components_common_ErrorMessage,
  C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_components_common_LoadingIndicator,
  C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_components_common_NotFoundMessage,
  C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_components_home_ResultSummary,
  C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_components_home_SearchBar,
  C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_components_home_ShowDocumentListList,
  C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_page_HomePage,
  C__Users_Ahmed_Zaman_Pranta_Downloads_SQA_assignment_frontend_src_page___test_TestProviders });

export { getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-Cdg8gM5r.js.map
